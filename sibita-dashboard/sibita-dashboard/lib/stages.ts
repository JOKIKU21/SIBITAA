...
/**
 * Satu field input pada form tahapan (diambil dari index__6_.html).
 * `type` menentukan bagaimana field dirender pada halaman detail tahap.
 */
...
export interface StageField {
  label: string;
  type: StageFieldType;
  /** Hanya untuk type "readonly-list" (mis. Checklist Revisi / Checklist Ujian) */
  items?: string[];
}
...
/**
 * 16 tahapan tugas akhir. Konten setiap tahap (label field, checklist revisi,
 * perbandingan revisi) diambil dari form pada index__6_.html.
 * Daftar tugas (task checklist) SENGAJA tidak disertakan sesuai permintaan.
 */
export const STAGES: Stage[] = [
  {
    n: 1,
    slug: "diskusi-konsep-judul",
  ...
  },
  {
    ...
    comparison: {
      before:
        "Bab I masih belum mencakup latar belakang yang komprehensif. Pernyataan masalah kurang spesifik dan tujuan penelitian belum terukur.",
      after:
        "Bab I telah diperluas dengan latar belakang yang kuat. Pernyataan masalah diperinci dan tujuan penelitian menggunakan indikator yang terukur.",
    },
  },
  {
    n: 5,
    slug: "persiapan-ujian-proposal",
  ...
  },
  {
    ...
    comparison: {
      before:
        "Instrumen penelitian masih belum sepenuhnya mencerminkan indikator pada variabel penelitian. Beberapa butir pertanyaan bersifat ambigu dan berpotensi menimbulkan interpretasi ganda.",
      after:
        "Instrumen telah disesuaikan dengan indikator variabel penelitian. Redaksi pertanyaan diperjelas sehingga lebih mudah dipahami dan meminimalkan bias interpretasi.",
    },
  },
  {
    n: 8,
    slug: "pengambilan-data",
  ...
  {
    n: 10,
    slug: "penyusunan-bab-4",
    name: "Penyusunan BAB IV (Hasil & Pembahasan)",
    days: 14,
  ...
  },
  {
    ...
    comparison: {
      before:
        "Tabel dan grafik telah disajikan, namun beberapa visualisasi belum memiliki interpretasi yang memadai. Pembaca masih kesulitan memahami makna dari data yang ditampilkan.",
      after:
        "Setiap tabel dan grafik telah dilengkapi dengan interpretasi yang jelas serta penjelasan mengenai implikasi hasil penelitian, sehingga informasi yang disajikan lebih mudah dipahami.",
    },
  },
  {
    n: 12,
  ...
  {
    n: 13,
    slug: "penyusunan-bab-5",
    name: "Penyusunan BAB V (Kesimpulan & Saran)",
    days: 7,
  ...
  },
  {
    n: 14,
    slug: "draft-final",
    name: "Penyusunan BAB I s.d. BAB V (Draft Final)",
    days: 7,
...
export function getStageByN(n: number): Stage | undefined {

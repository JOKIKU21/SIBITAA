  ...
  return (
    <>
      ...
      <main>
            ...
            <div className="max-w-135 -mt-7 max-[860px]:max-w-full max-[860px]:mt-0">
              ...
              <div className="flex gap-3.5 flex-wrap max-[860px]:justify-center max-[480px]:flex-col max-[480px]:w-full">
                <Button
                  ...
                  variant="white"
                  size="custom"
                  className="py-3.75 px-7 rounded-2.75 text-[14.5px] flex items-center gap-2 hover:-translate-y-0.5 hover:shadow-[0_10px_24px_rgba(0,0,0,0.2)] max-[480px]:w-full max-[480px]:justify-center"
                  rightIcon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M5 12h14M13 6l6 6-6 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>}
                >
                  Mulai Sekarang
                </Button>
                <Button
                  ...
                  size="custom"
                  className="py-3.75 px-7 rounded-2.75 text-[14.5px] max-[480px]:w-full max-[480px]:justify-center"
                >
                  Lihat Panduan
                </Button>
              </div>
        ...
        <section className="stats py-16 px-[5vw] pb-22 relative max-[768px]:py-10 max-[768px]:px-[4vw]">
          <div className="max-w-285 mx-auto relative z-2 grid grid-cols-4 gap-4.5 max-[860px]:grid-cols-2 max-[768px]:grid-cols-2 max-[768px]:gap-4 max-[480px]:grid-cols-1">
            <div className="stat-item stat-item-1 relative text-left py-6 px-5.5 rounded-5 border-none text-white overflow-hidden bg-linear-to-br from-[#FF6B9E] to-[#B450E1] shadow-[0_16px_32px_rgba(180,80,225,0.2)] transition-[transform,box-shadow] duration-300 ease-out hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.25)]">
            ...
            <div className="stat-item stat-item-3 relative text-left py-6 px-5.5 rounded-5 border-none text-white overflow-hidden bg-linear-to-br from-[#4FA4F8] to-[#37D5ED] shadow-[0_16px_32px_rgba(55,213,237,0.2)] transition-[transform,box-shadow] duration-300 ease-out hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.25)]">
            ...
            <div className="stat-item stat-item-4 relative text-left py-6 px-5.5 rounded-5 border-none text-white overflow-hidden bg-linear-to-br from-[#4CE0A6] to-[#34B192] shadow-[0_16px_32px_rgba(52,177,146,0.2)] transition-[transform,box-shadow] duration-300 ease-out hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.25)]">
        ...
        <section className="py-20 px-[5vw] pb-24 bg-linear-to-b from-[#F8F9FD] to-white max-[768px]:py-10 max-[768px]:px-[4vw]">
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(260px,1fr))] gap-6 max-w-270 mx-auto">
            <div className="feature-card relative bg-linear-to-br from-[#3244CA] to-brand-dark border-none rounded-5 py-9 px-7 text-left text-white overflow-hidden shadow-[0_16px_32px_rgba(26,37,128,0.2)] transition-[transform,box-shadow] duration-300 ease-out hover:shadow-[0_20px_48px_rgba(26,37,128,0.35)] hover:-translate-y-2">
              <div className="relative w-13 h-13 rounded-3.5 bg-white/12 border border-white/20 mb-6 flex items-center justify-center backdrop-blur-xs">
      ...
      <footer className="bg-[#0f1430] text-white py-12 px-[5vw] pb-0 font-body border-t border-white/5 max-[768px]:py-10 max-[768px]:px-[4vw] max-[768px]:pb-0">
        <div className="max-w-300 mx-auto grid grid-cols-[2.2fr_1fr_1fr_1.5fr] gap-8 pb-8 max-[860px]:grid-cols-2 max-[768px]:grid-cols-1 max-[768px]:gap-6">
          ...
          <div className="flex flex-col gap-3">
            <h4 className="font-display text-[13px] font-bold uppercase tracking-widest text-white mb-4">Hubungi Kami</h4>
            <div className="flex items-start gap-3 text-[13.5px] text-white/70 leading-normal">
        ...
        <div className="border-t border-white/8 py-4.5 px-[5vw] bg-[#0b0f24]">
          <div className="max-w-300 mx-auto flex justify-center items-center text-[13px] text-white/50 flex-wrap gap-4">
